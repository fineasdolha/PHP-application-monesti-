...
<section class="d-flex justify-content-center align-items-end" style="min-height: 10em;">  
    <a href="login.php"><button type="button" style="width: 200px; height:80px;" class="btn btn-primary m-5">Login</button></a>
    <a href="index.php"><button type="button" style="width: 200px; height:80px;" class="btn btn-primary m-5">Return to homepage</button></a>
</section> 
