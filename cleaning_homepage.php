        ...
        <form id="formClean" method="post">
          <div class="darker mt-4 text-justify">
            <div class="lead row ">
              ...
              <div>
                <button class="btn" style="background:#ecb21f; font-size:1em;margin-bottom:10px" type="submit" <?php if (isset($_POST['workdone']) && isset($_POST['timePeriod']) == null || isset($_SESSION['message1']) != '') { ?> disabled <?php } ?> onchange="this.form.submit()" name="workdone" id='workdone'>WORK DONE</button>
              </div>
              <div>
          ...
          <div class="col-sm-5 col-md-6 col-12 pb-4">
            ...
            <?php foreach ($elementComment as $row) { ?>
              <div class="darker mt-4 text-justify">
                ...
                <span>envoyé le : <?php print $_SESSION['time_stamp']; ?></span><br>
              </div>
            <?php } ?>
          </div>
          ...
          <div class="col-lg-4 col-md-5 col-sm-4 offset-md-1 offset-sm-1 col-12 mt-4">
            <form id="algin-form" method="post">
              <div class="darker mt-4 text-justify">
                ...
                <div class="form-group">
                  <button type="submit" onchange="this.form.submit()" id="post" class="btn">Post Comment</button>
                </div>
              </div>
            </form>
          </div>
